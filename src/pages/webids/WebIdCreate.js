...
const WebIdCreate = () => {
    ...
    const handleSubmit = async(e)=>{
        ...
        await fetch("http://localhost:8081/webids", {
            method:'POST',
  ...
  return (
    <div className="container h-full w-full bg-slate-300">
      <div className="text-center pt-16 ">
        <h2 className="text-2xl"> 사이트 정보 등록</h2>
      </div>
      <div className=" w-full mt-8">
        <form className="w-5/6 mx-auto  bg-gray-400 rounded-lg " onSubmit ={handleSubmit}>
